...
def run():
    ...
    for gameid in gameids:
        if int(gameid) >= 2020020053 and int(gameid) < 2021000000:
...
# pairs:
# 1988030231, 1989000000
# 1991020493, 1992000000
# 1994020402, 1995000000
# 1998020742, 2000000000
# 2000000000, 2002000000
# 2007010040, 2009000000
# 2009021174, 2011000000
# 2014021075, 2015000000
# 2018021243, 2019000000